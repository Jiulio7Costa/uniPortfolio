...
<template>
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <img src="/logo2.png" class="h-6" alt="Elos Logo" />
            <span
                class="self-center text-3xl font-extrabold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent whitespace-nowrap">
                ELOS
            </span>
            </Link>
            <div v-if="canLogin" class="flex items-center md:order-2 gap-4 md:space-x-0 rtl:space-x-reverse">
                <div class="mr-4">
                    <Link :href="route('cart.view')"
                        class="relative inline-flex items-center p-2 text-sm font-medium text-center text-white bg-black rounded-md hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-500 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                    ...
                    <div
                        class="absolute inline-flex items-center justify-center w-5 h-5 text-[11px] font-bold text-white bg-red-500 border-2 border-white rounded-full -top-1.5 -end-1.5 dark:border-gray-900">
                        {{ cart.data.count }}</div>
                    </Link>
    ...
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 
        ...
        <li>
            ...
            class="block py-2 px-3 text-gray-900 rounded-sm md:p-0 dark:text-white 
                ...
                md:dark:hover:bg-transparent dark:border-gray-700 transition-all duration-200 ease-in-out hover:underline hover:underline-offset-4">
                Home
            </Link>
        </li>
