  ...
  <nav
    ...
    <div class="flex flex-wrap justify-between items-center">
      <div class="flex justify-start items-center">
        ...
        <Link :href="route('admin.dashboard')" class="flex items-center gap-3 mr-4">
        <img src="/logo2.png" alt="ELOS Logo" class="h-8 w-auto" />
        <span class="text-2xl font-semibold whitespace-nowrap dark:text-white">ELOS</span>
        </Link>
      ...
      <div class="flex items-center lg:order-2">
        ...
        <button type="button"
          ...
          <img class="w-8 h-8 rounded-full"
            src="https://ui-avatars.com/api/?name=Admin&background=0D8ABC&color=fff&bold=true" alt="Admin Avatar" />
        </button>
        <!-- Dropdown menu -->
        <div
